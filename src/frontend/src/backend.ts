...
export class Backend implements backendInterface {
    ...
    async getFeaturedStory(): Promise<Story> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedStory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStoriesByCategory(arg0: string): Promise<Array<Story>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoriesByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStoryByTitle(arg0: string): Promise<Story> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoryByTitle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setMotivationalQuote(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setMotivationalQuote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
